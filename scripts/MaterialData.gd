...
static func get_refine_only_items() -> Array:
	return [
		...
		{ "id": "tianhuoshi_bao", "name": "天火石", "tier": Tier.BAO, "element": Element.HUO, "base_price": 150000, "desc": "从天而降的陨铁，火系至宝。身价十五上品灵石——散修十辈子也攒不出", "origin": "炎狱域" },
		{ "id": "xuanbingjing_bao", "name": "玄冰晶", "tier": Tier.BAO, "element": Element.SHUI, "base_price": 120000, "desc": "万载玄冰之心，炼器圣品。十二上品——一方豪强倾家荡产才能竞逐", "origin": "玄冰域" },
		{ "id": "jinwusha_bao", "name": "金乌砂", "tier": Tier.BAO, "element": Element.JIN, "base_price": 200000, "desc": "传说中的金乌陨落处产出的神砂。二十上品——小宗门举全宗之力方敢问价", "origin": "金戈域" },
		{ "id": "shenmuye_bao", "name": "神木液", "tier": Tier.BAO, "element": Element.MU, "base_price": 100000, "desc": "千年神木分泌的灵液，一滴可令枯木逢春。十上品，有价无市", "origin": "苍木域" },
		# ===== 仙品（3种）— 熔炼终极目标，传说级 =====
		{ "id": "wuxinglingzhu_xian", "name": "五行灵珠", "tier": Tier.XIAN, "element": Element.TU, "base_price": 15000000, "desc": "古神遗物。身价十五极品灵石——此物出世，五大宗门倾巢而出，血流成河", "origin": "中央荒原" },
		{ "id": "fenghuangxie_xian", "name": "凤凰精血", "tier": Tier.XIAN, "element": Element.HUO, "base_price": 12000000, "desc": "一滴凤凰心头血，可令凡人脱胎换骨。十二极品——各大势力不惜灭门相争", "origin": "炎狱域" },
		{ "id": "jiutianxirang_xian", "name": "九天息壤", "tier": Tier.XIAN, "element": Element.TU, "base_price": 8000000, "desc": "女娲造人所用的神土。八极品——只存在于古籍中，一粒可演化一方洞天", "origin": "中央荒原" },
	]
