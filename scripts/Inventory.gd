...
func _refresh_items():
	...
	for item in display_items:
		...
		match item.tier:
			0: card_color = Color(0.12, 0.12, 0.18, 0.9)  # 凡品 - 灰
			1: card_color = Color(0.12, 0.18, 0.25, 0.9)  # 灵品 - 蓝
			2: card_color = Color(0.2, 0.15, 0.08, 0.9)   # 宝品 - 金
			3: card_color = Color(0.2, 0.08, 0.2, 0.9)    # 仙品 - 紫
